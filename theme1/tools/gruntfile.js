module.exports = function (grunt) {
    ...
    function external() {
        return function () {
            return path.join.apply(null, ['../../bcthemes/public/js/_compiled/'].concat(__slice.call(arguments)));
        };
    }
    function vendor() {
        return path.join.apply(null, ['../../bcthemes/public/js/vendor/'].concat(__slice.call(arguments)));
    }
    function bower() {
        ...
        less: {
            development: {
                ...
                files: {
                    ...
                    "../../bcthemes/public/css/main.css": "../less/bc_bootstrap.less",
                }
            }
        },
